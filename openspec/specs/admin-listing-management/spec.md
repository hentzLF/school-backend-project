# Spec: Admin Listing Management

## Purpose
Defines admin CRUD and activation operations for managing service listings, including listing views, detail, editing, activate/deactivate toggles, and deletion.
