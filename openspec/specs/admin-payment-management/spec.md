# Spec: Admin Payment Management

## Purpose
Defines admin operations for viewing payments and resolving disputed payments, including filtered list views, detail views, and release/refund dispute resolution.
