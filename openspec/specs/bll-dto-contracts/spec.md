# Capability: bll-dto-contracts

## Purpose
Defines the shared DTO (Data Transfer Object) contracts used across service boundaries in the BLL. These types are the exclusive data exchange types between the BLL and presentation layers (API and Web).
