...
Playwright E2E test infrastructure: project setup, shared fixture with Testcontainers PostgreSQL, browser lifecycle, authenticated page helpers, Page Object base class, and xUnit collection sharing.
