# Spec: Resource Ownership

## Purpose

Defines authorization rules ensuring that mutation and read operations on listings, reviews, and user profiles are restricted to the owning authenticated principal. Prevents IDOR by verifying JWT claims against resource ownership before allowing access or revealing sensitive data.
